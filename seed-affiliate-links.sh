...
# NOTE: Replace PLACEHOLDER with actual Refersion/AWIN codes once Bill has them
...
wrangler kv key put --namespace-id=$KV_NS_ID "venty" \
  '{"url":"https://www.planetofthevapes.com/products/storz-and-bickel-venty?rfsn=PLACEHOLDER","network":"potv-refersion","product":"Storz & Bickel Venty","commission_rate":"15%","avg_price":375}'

wrangler kv key put --namespace-id=$KV_NS_ID "mighty-plus" \
  '{"url":"https://www.planetofthevapes.com/products/mighty-plus-vaporizer?rfsn=PLACEHOLDER","network":"potv-refersion","product":"Storz & Bickel Mighty+","commission_rate":"15%","avg_price":275}'

wrangler kv key put --namespace-id=$KV_NS_ID "arizer-solo-3" \
  '{"url":"https://www.planetofthevapes.com/products/arizer-solo-3?rfsn=PLACEHOLDER","network":"potv-refersion","product":"Arizer Solo 3","commission_rate":"10%","avg_price":220}'

wrangler kv key put --namespace-id=$KV_NS_ID "potv-lobo" \
  '{"url":"https://www.planetofthevapes.com/products/potv-lobo?rfsn=PLACEHOLDER","network":"potv-refersion","product":"POTV Lobo","commission_rate":"15%","avg_price":150}'

wrangler kv key put --namespace-id=$KV_NS_ID "xmax-v3-pro" \
  '{"url":"https://www.planetofthevapes.com/products/xmax-v3-pro?rfsn=PLACEHOLDER","network":"potv-refersion","product":"XMAX V3 Pro","commission_rate":"15%","avg_price":100}'
...
wrangler kv key put --namespace-id=$KV_NS_ID "potv-store" \
  '{"url":"https://www.planetofthevapes.com/?rfsn=PLACEHOLDER","network":"potv-refersion","product":"POTV Store","commission_rate":"15%"}'
...
echo ""
echo "REMINDER: Update PLACEHOLDER values after POTV Refersion and AWIN approval."
echo "  wrangler kv key put --namespace-id=${KV_NS_ID} \"venty\" '{...real URL...}'"
